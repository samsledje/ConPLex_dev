...
parser.add_argument('--checkpoint', default=None, required=True, help='Model weights to start from')
...
def main():
    ...
    try:
        with torch.set_grad_enabled(False):
            ...
            test_auc, test_auprc, test_f1, test_accuracy, test_sensitivity, test_specificity, test_logits, test_loss = test(testing_generator, model)
            test_end_time = time()
            print(
