...
class DrugTargetCoembeddingLightning(pl.LightningModule):
    def __init__(self,
        ...
        self.drug_dim = molecule_embedding_dim
        self.target_dim = protein_embedding_dim
    ...
    def forward(self, drug, protein):
        ...
        if self.classify:
            similarity = nn.CosineSimilarity()(drug_projection,target_projection)
        else:
            similarity = torch.bmm(drug_projection.view(-1,1,self.latent_dim), target_projection.view(-1,self.latent_dim,1)).squeeze()
