...
parser.add_argument('--clr', '--contrastive-learning-rate', default=1e-5, type=float,
                    metavar='CLR', help='initial learning rate (default: 1e-5)', dest='clr')
...
parser.add_argument('--dude-train',choices=['within','cross'],default='', type=str, metavar='DUDE_TASK', required=True,
